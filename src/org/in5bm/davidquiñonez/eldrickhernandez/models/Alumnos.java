...
public class Alumnos {
    ...
    public Alumnos(String nombre1, String nombre2, String nombre3,
    ...
    public Alumnos(String carne, String nombre1, String nombre2, String nombre3,
            String apellido1, String apellido2) {
        this.carne = carne;
        this.nombre1 = nombre1;
        this.nombre2 = nombre2;
    ...
    public String toString() {
        return "Alumnos{" + "carne=" + carne + ", nombre1=" + nombre1 + ","
